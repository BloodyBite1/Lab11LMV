...
namespace Lab._11
{
    public partial class Bloody_Bite : Form
    {
        int i = 0;
        public Bloody_Bite()
        {
        ...
        {
            MessageBox.Show("Меню розробив студент гр. IPZ-41  Мельничук Станіслав", "info", MessageBoxButtons.OKCancel, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1);
        }

        private void toolStripButton4_Click(object sender, EventArgs e)
        {
            MessageBox.Show("Web-браузер розробив студент гр. IPZ-41  Мельничук Станіслав e-mail MobPsyho000@gmail.com", "info", MessageBoxButtons.OKCancel, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1);
        }
